...
export const genresOptions: Option[] = genres.map(
  (genre: string): Option =>
    <Option>{
...
export const top5 = {
  ...
  cast: ['Keanu Reeves', 'Laurence Fishburne', 'George Georgiou', 'Lance Reddick', 'Clancy Brown'],
  director: ['Chad Stahelski'],
  producer: ['Christoph Fisser', 'Basil Iwanyk', 'Ilene Kim', 'Erica Lee', 'David Leitch'],
...
export const top4 = {
  ...
  producer: ['Joe Anton', 'Brian Bell', 'Erin Charles', 'Jules Daly', 'Ana de Armas'],
  writer: ['Rhett Reese', 'Paul Wernick', 'Chris McKenna', 'Erik Sommers', 'Rhett Reese'],
};
...
export const top3 = {
  ...
  type: 'movie',
  image_url:
    'https://m.media-amazon.com/images/M/MV5BOTlmNGE0ZGMtMzdkMC00MjQyLWI1ZjgtZTIxODAyNWJlZDFlXkEyXkFqcGdeQXVyNTQ4ODM2NjM@._V1_.jpg',
  year: 2023,
  minutes: 111,
  ...
  cast: ['Mark Rowley', 'Pekka Strang', 'Zoltan Andrasi', 'Ingrid García Jonsson', 'Agnes Born'],
...
export const top2 = {
  ...
  director: ['Lee Cronin'],
  producer: ['Romel Adam', 'Richard Brener', 'Bruce Campbell', 'Moira Grant', 'Macdara Kelleher'],
  writer: ['Lee Cronin'],
};
...
export const top6 = {
  ...
  type: 'movie',
  image_url:
    'https://m.media-amazon.com/images/M/MV5BYTNhNWRmMDctYzE4OS00MzczLWJkODgtNzYxZTQxM2Y1YmM3XkEyXkFqcGdeQXVyMTkxNjUyNQ@@._V1_.jpg',
  year: 2023,
  minutes: 179,
  ...
  director: ['Ari Aster'],
  producer: ['Elisa Alvares', 'Timo Argillander', 'Ari Aster', 'Len Blavatnik', 'Luca Borghese'],
  writer: ['Ari Aster'],
};
...
export const top7 = {
  ...
  type: 'movie',
  image_url:
    'https://m.media-amazon.com/images/M/MV5BNDIwYjVjMDMtOGYxMy00ZTRiLWE0YzktMjIwYmNhOGE4NGQ4XkEyXkFqcGdeQXVyNjY1MTg4Mzc@._V1_.jpg',
  year: 2023,
  minutes: 93,
  ...
  producer: ['David Alpert', 'Bryan Furst', 'Sean Furst', 'Gary Huckabay', 'Robert Kirkman'],
...
export const top8 = {
  ...
  rating_count: 50326,
  summary:
    "A former Harper named Edgin Darvis and his accomplice Holga Kilgore are imprisoned for two years. Upon their escape, they discover that their former ally, Forge Fitzwilliam, has become the Lord of Neverwinter. In an effort to clear their names and revive Edgin's wife, they plan to steal a valuable artifact from Forge's vault. They recruit the help of Simon Aumar and Doric, and together they embark on a perilous journey to retrieve a powerful relic. However, they soon discover that they are being pursued by dangerous enemies, including a Red Wizard named Sofina, who will stop at nothing to stop them.",
  outline:
...
export const top10 = {
  ...
  type: 'movie',
  image_url:
    'https://m.media-amazon.com/images/M/MV5BYmNlOTNlYjUtM2U3Yy00M2ZjLTkxZDQtN2NiNGZiZDI0ZjE3XkEyXkFqcGdeQXVyMTUzMTg2ODkz._V1_.jpg',
  year: 2023,
  minutes: 111,
  genres: ['Drama', 'Sport'],
  release: '2023-04-05',
  ...
  producer: ['Ben Affleck', 'Madison Ainley', 'Jason Michael Berman', 'Alex Convery', 'Matt Damon'],
  writer: ['Alex Convery'],
};
...
export const top9 = {
  ...
  type: 'movie',
  image_url:
    'https://m.media-amazon.com/images/M/MV5BYjA0MGU4MzYtYTYxMy00MjRhLTlmMDYtZTVhZDc1Y2QwNWY2XkEyXkFqcGdeQXVyMjY5ODI4NDk@._V1_.jpg',
  year: 2023,
  minutes: 103,
